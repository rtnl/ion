...
t_ion_result_code ion_buffer_io_read_arr_check(t_ion_buffer *self, t_ion_object_kind kind_item, uint8_t len);
...
t_ion_result_code ion_buffer_io_peek_arr_check(t_ion_buffer *self, t_ion_object_kind kind_item, uint8_t len);
